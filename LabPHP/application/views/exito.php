<html>
    ...
    <body>
        <div id="logo">
            <a href="<?= base_url().'/index.php/usuario/index'?>" style="text-align:center;">
        ...
        <div class="row d-flex flex-column align-items-center">
            <a href="<?= base_url().'/index.php/usuario/index'?>" style="text-align:center;"><button type="submit" class="button button1"><b style="color: white;">Volver al inicio</b></button></a>
        </div>
